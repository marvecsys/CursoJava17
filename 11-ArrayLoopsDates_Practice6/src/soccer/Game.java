...
public class Game {
    ...
    public String getDescription() {
        ...
        returnString.append(this.getHomeTeam().getTeamName()).append(" vs. ").append(this.getAwayTeam().getTeamName())
                .append("\nDate: ").append(this.theDateTime.format(DateTimeFormatter.ISO_LOCAL_DATE)).append("\n");
